...
def transfer(data_dir, BATCH_SIZE=100):
    base_model = keras.applications.ResNet50(
        ...
        include_top=False)
    feats = tf.data.Dataset.from_generator(img_proc.Data_Generator(data_dir / 'train_sep', BATCH_SIZE, shuffle=True, flatten=False, model=base_model, flatten_post_model=True))
